...
Un assuré qui roule beaucoup acquiert de l'expérience et devient un bon conducteur. Il a cependant mécaniquement plus de chance d'être sinistré car il fait plus de kilomètres. Il s'agit d'un sujet d'actualité à l'étude dans de nombreuses compagnies d'assurance.

On ne parle jamais d'assurance auto sans évoquer la variable sexe. Alexandre nous a révélé que
...
*"Une idée n'est pas une innovation, un concept n'est pas une innovation, une invention n'est pas une innovation,"*
...
Elle nous a présenté différentes techniques aidant à l'innovation scindées en deux groupes.
...
D'un autre côté les techniques de convergence comme la __matrice de sélection__ qui permet de localiser notre idée en termes de compromis impact/effort.
...
Claire sera bientôt une doctorante de l'ISFA, en convention CIFRE avec AXA et co-encadré par [Christophe Dutang][CDutang]

![CMouminoux](/Photos/WeTeamBuildingMontpellier/ClaireMouminoux.png "Claire Mouminoux")

Claire est diplomée de la [Toulouse School of Economics][TSE]. Elle ambitionne d'adapter des concepts de théorie des jeux à la modélisation du comportements des acteurs économiques sur le marché de l'assurance.

Ainsi, nous retrouverons des problèmes d'optimisation simultanée de fonction de profitabilité pour différentes compagnies d'assurance.

L'une de ses pistes est aussi d'étudier l'impact de l'arrivée de l'assurance directe sur le marché français.

*"Mais Qu'est-ce que l'assurance directe?"*

Ai-je demandé naïvement sous les rires de mes collègues doctorants.

L'assurance directe est une nouvelle pratique qui permet aux clients de souscrire des contrats d'assurance en ligne sans passer par les intermédiaires classiques commes les commerciaux ou les agents généraux.

Cette pratique a été largement adoptée en Grande-Bretagne et le sera certainement bientôt en France ce qui aura bien sûr un impact sur le marché.
...
![PValade](/Photos/WeTeamBuildingMontpellier/PierreValade.png "Pierre Valade")

*"ACPR, vos papiers s'il vous plait!"*

Sa thèse va porter sur le pouvoir des autorités de supervision, dont il précise la véritable philosophie
...
Son travail sera en plus supporté par un accès à des bases de données de grands assureurs, de l' OCDE, des banques centrales...

*"Au pire si la thèse ça marche pas, tu vends les données et tu pars t'installer sur une île!"*

Merci Pierre V.

### Clap de fin

Le week-end s'achève sur une délicieuse paella.

![Paella](/Photos/WeTeamBuildingMontpellier/Paella.jpg "Mmm la Paella")

Le week-end s'est donc déroulé sans accrocs, mis à part les ratages de trains successifs et l'oubli d'achat de tickets de Tram.

*"Non, mais on a pas eu le temps..."*

Haha.

Nous remercions la chaire actuariat durable pour avoir sponsorisé en partie cet évènement.

![ActuariatDurable](/Photos/WeTeamBuildingMontpellier/LOGO ACTUARIAT DURABLE_FINAL-01.jpg "Logo de la Chaire Actuariat durable")
...
[StephaneLoisel]: http://isfaserveur.univ-lyon1.fr/~stephane.loisel/
[Bluenove]: http://www.bluenove.org/
[Milliman]: http://fr.milliman.com
[Allianz]: https://www.allianz.fr
[CDutang]: http://dutangc.free.fr
